...
O exemplo de contexto montado abaixo, se baseia nos dados origniais da base de conhecimento, mas os sintetiza deixqando apenas as informações mais releveantes, otimizando o consumo de tokens, Entretanto vale lembrar que mais importante do que economizar tokens, é ter todas as informações relevantes disponíveis em seu contexto.
